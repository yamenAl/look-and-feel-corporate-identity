...
Ontwerp en maak een *styleguide* voor een opdrachtgever.

<!-- 
deeltaken: [Living styleguide](https://github.com/fdnd-task/look-and-feel-living-styleguide)
...
De HTML voor de componenten, met CSS classes, cusotm props of anders...
...
Een styleguide is essentieel voor het begrijpen en overbrengen van de look and feel van een website. Het geeft voorbeelden en uitleg over hoe iets eruit moet zien en hoe markup (HTML) en vormgeving (CSS) moeten worden toegepast. Een styleguide helpt bij het ontwerpen en bouwen van een website met consistente look and feel in de huisstijl van een opdrachtgever.
...
Je hebt inmiddels een beeld van wat een huisstijl is. De meeste opdrachtgevers van FDND-Agency maken gebruik van een of andere styleguide waarin de huisstijl vastgelegd is. 
...
Voorbeelden van een Living Styleguides zijn de [Decathlon Design System](https://www.decathlon.design/726f8c765/p/75e137-digital-overview) en [Familysearch Styleguide](https://www.familysearch.org/frontier/styleguide/).
